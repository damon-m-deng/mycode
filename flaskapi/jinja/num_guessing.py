...
def index(score):
    # render the template with the value of score for damon_guess
    # damon_guess is a jinja var in the HTML template
    return render_template("highscore.html", damon_guess=score)
